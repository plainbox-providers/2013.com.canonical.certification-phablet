...
setup(
    name='2013.com.canonical.certification:phablet',
    version="1.0",
    description=N_("The 2013.com.canonical.certification:phablet provider"),
    gettext_domain="2013_com_canonical_certification_phablet",
)